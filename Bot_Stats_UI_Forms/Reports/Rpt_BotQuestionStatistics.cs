...
{
    public partial class Rpt_BotQuestionStatistics : Form
    {
        private db_ChatBot_Entities db = new db_ChatBot_Entities();

        public Rpt_BotQuestionStatistics(int? id)
        {
            InitializeComponent();
        ...
        private void Rpt_QuestionIntentScore_Load(object sender, EventArgs e)
        {
            reportViewer1.LocalReport.ReportEmbeddedResource =
                "Bot_Stats_UI_Forms.Reports.Rpt_BotQuestionStatistics.rdlc";

              ReportDataSource rds = new ReportDataSource("ds_BotQuestionStat",
                  bindingSource);
